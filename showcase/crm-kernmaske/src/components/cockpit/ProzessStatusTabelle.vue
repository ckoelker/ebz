...
import { PROZESSE } from '../../mock/data'
import { healthColor, healthLabel } from '../../ui'
import type { Prozess } from '../../types'
    ...
    >
      ...
      <div class="min-w-0 flex-1">
        <div class="flex items-center gap-2">
          ...
          <span class="size-2 rounded-full shrink-0" :class="{
            'bg-success': p.health === 'ok', 'bg-warning': p.health === 'warn', 'bg-error': p.health === 'err',
          }" />
        </div>
