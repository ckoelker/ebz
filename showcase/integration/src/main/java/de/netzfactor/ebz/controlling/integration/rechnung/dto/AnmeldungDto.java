 ...
 * die Vollständigkeits-/Stimmigkeitsregeln für BERUFSSCHULE sind Cross-Field und liegen server-seitig
 * in {@link StimmigeBerufsschulAnmeldung} (Beträge = variable Werte je Anmeldung, Entscheidung a).
 * Hochschule-Felder sind vorbereitet (Logik R6).
 */
