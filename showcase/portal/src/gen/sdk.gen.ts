 ...
 * Konten
 */
export const getMockSuite8Konten = <ThrowOnError extends boolean = false>(options?: Options<GetMockSuite8KontenData, ThrowOnError>): RequestResult<GetMockSuite8KontenResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetMockSuite8KontenResponses, unknown, ThrowOnError>({ url: '/mock/suite8/konten', ...options });

/**
 * Status
 */
export const getMockSuite8Status = <ThrowOnError extends boolean = false>(options?: Options<GetMockSuite8StatusData, ThrowOnError>): RequestResult<GetMockSuite8StatusResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetMockSuite8StatusResponses, unknown, ThrowOnError>({ url: '/mock/suite8/status', ...options });

/**
 * Verfuegbarkeit
 */
export const postMockSuite8Verfuegbarkeit = <ThrowOnError extends boolean = false>(options?: Options<PostMockSuite8VerfuegbarkeitData, ThrowOnError>): RequestResult<PostMockSuite8VerfuegbarkeitResponses, unknown, ThrowOnError> => (options?.client ?? client).post<PostMockSuite8VerfuegbarkeitResponses, unknown, ThrowOnError>({ url: '/mock/suite8/verfuegbarkeit', ...options });

/**
 * Schueler
 */
export const getMockWebuntisSchueler = <ThrowOnError extends boolean = false>(options?: Options<GetMockWebuntisSchuelerData, ThrowOnError>): RequestResult<GetMockWebuntisSchuelerResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetMockWebuntisSchuelerResponses, unknown, ThrowOnError>({ url: '/mock/webuntis/schueler', ...options });

/**
 * Status
 */
export const getMockWebuntisStatus = <ThrowOnError extends boolean = false>(options?: Options<GetMockWebuntisStatusData, ThrowOnError>): RequestResult<GetMockWebuntisStatusResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetMockWebuntisStatusResponses, unknown, ThrowOnError>({ url: '/mock/webuntis/status', ...options });

/**
 * Verfuegbarkeit
 */
export const postMockWebuntisVerfuegbarkeit = <ThrowOnError extends boolean = false>(options?: Options<PostMockWebuntisVerfuegbarkeitData, ThrowOnError>): RequestResult<PostMockWebuntisVerfuegbarkeitResponses, unknown, ThrowOnError> => (options?.client ?? client).post<PostMockWebuntisVerfuegbarkeitResponses, unknown, ThrowOnError>({ url: '/mock/webuntis/verfuegbarkeit', ...options });

/**
 * Liste
 */
export const getOutbox = <ThrowOnError extends boolean = false>(options?: Options<GetOutboxData, ThrowOnError>): RequestResult<GetOutboxResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetOutboxResponses, unknown, ThrowOnError>({ url: '/outbox', ...options });

/**
 * Dispatch
 */
export const postOutboxDispatch = <ThrowOnError extends boolean = false>(options?: Options<PostOutboxDispatchData, ThrowOnError>): RequestResult<PostOutboxDispatchResponses, PostOutboxDispatchErrors, ThrowOnError> => (options?.client ?? client).post<PostOutboxDispatchResponses, PostOutboxDispatchErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/outbox/dispatch',
    ...options
});
 ...
 * Neu Versuch
 */
export const postOutboxByIdNeuVersuch = <ThrowOnError extends boolean = false>(options: Options<PostOutboxByIdNeuVersuchData, ThrowOnError>): RequestResult<PostOutboxByIdNeuVersuchResponses, PostOutboxByIdNeuVersuchErrors, ThrowOnError> => (options.client ?? client).post<PostOutboxByIdNeuVersuchResponses, PostOutboxByIdNeuVersuchErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * Meine Rechnungen
 */
export const getPartyPortalRechnungen = <ThrowOnError extends boolean = false>(options?: Options<GetPartyPortalRechnungenData, ThrowOnError>): RequestResult<GetPartyPortalRechnungenResponses, GetPartyPortalRechnungenErrors, ThrowOnError> => (options?.client ?? client).get<GetPartyPortalRechnungenResponses, GetPartyPortalRechnungenErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * Zugferd
 */
export const getPartyPortalRechnungenByIdZugferd = <ThrowOnError extends boolean = false>(options: Options<GetPartyPortalRechnungenByIdZugferdData, ThrowOnError>): RequestResult<GetPartyPortalRechnungenByIdZugferdResponses, GetPartyPortalRechnungenByIdZugferdErrors, ThrowOnError> => (options.client ?? client).get<GetPartyPortalRechnungenByIdZugferdResponses, GetPartyPortalRechnungenByIdZugferdErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * Rechnungs Kontexte
 */
export const getPartyPortalRechnungsKontexte = <ThrowOnError extends boolean = false>(options?: Options<GetPartyPortalRechnungsKontexteData, ThrowOnError>): RequestResult<GetPartyPortalRechnungsKontexteResponses, GetPartyPortalRechnungsKontexteErrors, ThrowOnError> => (options?.client ?? client).get<GetPartyPortalRechnungsKontexteResponses, GetPartyPortalRechnungsKontexteErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * Versenden
 */
export const postRechnungRechnungenByIdVersenden = <ThrowOnError extends boolean = false>(options: Options<PostRechnungRechnungenByIdVersendenData, ThrowOnError>): RequestResult<PostRechnungRechnungenByIdVersendenResponses, PostRechnungRechnungenByIdVersendenErrors, ThrowOnError> => (options.client ?? client).post<PostRechnungRechnungenByIdVersendenResponses, PostRechnungRechnungenByIdVersendenErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
