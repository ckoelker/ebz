...
const input = {
  ...
  filters: {
    ...
    tags: ['Bildung Resource', 'Dubletten Review Resource', 'Anmeldung Workflow Resource', 'LMS Katalog', 'LMS Einschreibung', 'Crm Resource', 'Admin Kommunikation Resource', 'Rechnung Resource', 'HubSpot Sync Resource'],
  },
};
