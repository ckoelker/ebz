...
| 19 | **PMS Gästehaus** | DOMÄNE | **Suite8** (inkl. C&C); Kosten enorm, Zukunft offen | ⏸️ RFI GEPARKT (ohne Ergebnis) | 4 Wege recherchiert (SIHOT · OPERA Cloud S&E · Best-of-Breed · Hybrid) — **inaktiv, kein Treiber**. Siehe [RFI (geparkt)](PMS-Gaestehaus-RFI.md) | ⏸️ |
...
| S4 | **PMS Gästehaus** ↔ Kern | Gäste (= teils dieselben Kunden), Debitoren | ↔️ | API/Webhooks | **GEPARKT** (#19, ohne Ergebnis) — Konzept in [RFI (geparkt)](PMS-Gaestehaus-RFI.md), **kein aktiver Treiber** | ⏸️ |
