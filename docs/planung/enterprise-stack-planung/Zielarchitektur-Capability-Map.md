...
| 11 | **PMS (Gästehaus)** | Satellit | **Conference-House** (PMS + C&C/Bankett + POS), nicht nur Hotel-PMS | **SIHOT** · OPERA Cloud S&E · Best-of-Breed (Apaleo+iVvy) — siehe [RFI](PMS-Gaestehaus-RFI.md) | QloApps/HotelDruid (OSS) decken **kein** Bankett/Bestuhlung | Buy — **niemals** selbst |
