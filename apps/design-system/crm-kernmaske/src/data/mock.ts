...
// Referenzdaten + reine Party-Helfer liegen in der Domänenschicht; hier nur re-exportiert,
// damit Bestands-Importe aus data/mock weiter funktionieren.
export { LOOKUPS } from '../domain/lookups'
export { personName, initialen } from '../domain/party'
...
// ---- Daten-Zugriffshelfer (operieren auf den Mock-Arrays) ----
